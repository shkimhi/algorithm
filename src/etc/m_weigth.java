...
public class m_weigth {
    public static int weight() {
        ...
        if(standardIndex <= 85){
            ...
            System.out.println("당신의 표준체중지수는" + (Math.floor(standardIndex*1000)/1000.0) + "으로 마른형입니다.");
            ...
            System.out.println("표준체중 = " + standard);
            System.out.println("당신의 표준체중지수는" + (Math.floor(standardIndex*1000)/1000.0) + "으로 표준형입니다.");
        }else if(standardIndex >= 116 && standardIndex <= 125){
            System.out.println("표준체중 = " + standard);
            System.out.println("당신의 표준체중지수는" + (Math.floor(standardIndex*1000)/1000.0) + "으로 조금 비만형입니다.");
        }else {
            System.out.println("표준체중 = " + standard);
            System.out.println("당신의 표준체중지수는" + (Math.floor(standardIndex*1000)/1000.0) + "으로 비만형입니다.");
        }
